...
confirms the feed has been copied before showing Google Calendar’s official
**From URL** settings screen and the required paste step. Keep that flow: users
must paste the link once on a computer.
